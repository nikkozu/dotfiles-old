...
local PATH_TO_ICON = "/usr/share/icons/Papirus-Dark/symbolic/status/display-brightness-symbolic.svg"
local GET_BRIGHTNESS_CMD = "xbacklight -get"   -- "light -G"
local INC_BRIGHTNESS_CMD = "xbacklight -inc 2" -- "light -A 5"
local DEC_BRIGHTNESS_CMD = "xbacklight -dec 2" -- "light -U 5"
